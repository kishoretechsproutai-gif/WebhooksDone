...
urlpatterns = [
    ...
    path('inventory/riskalert/', get_risk_alerts, name='inventory_risk_alerts'), #Stockout Risk  #Risk Alerts Less than 30 days sales
    path('inventory/Reorder/', get_need_reordering,name='inventory_need_reordering'), #Sufficient Stock #Inventory + On Order > Forecast 30 days
